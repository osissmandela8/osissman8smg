        ...
        <article className="grid place-items-center bg-[#171717] pb-10">
          ...
          <div className="w-screen mt-14 md:w-[768px] p-[24px]">
            ...
            <p className="mt-5 text-[18px] md:text-22px">
              ...
              Feeds tersebut tercimta atas hasil dari kerja keras Tim
            ...
            <p className="mt-5 text-[18px] md:text-22px">
              ...
              tradisi yang bertujuan untuk mencimtakan lingkungan belajar yang
              nyaman dan bersih.
            </p>
            ...
            <ul className="mt-2 text-[18px] md:text-22px">
              <li>
              ...
              <li>
                <strong className="mt-5 text-slate-400">Kelas XI:</strong>
                <ul className="text-[18px] md:text-22px list-disc">
                  <li>Juara 1: XI-4</li>
            ...
            <img className="mt-5 rounded-[25px] w-full" src={K3} alt="K3"></img>
            ...
            <p className="mt-2 pb-2 text-[18px] md:text-22px">
