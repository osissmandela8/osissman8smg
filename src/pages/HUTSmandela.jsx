        ...
        <article className="grid place-items-center bg-[#171717] pb-10">
          ...
          <div className="w-screen mt-14 md:w-[768px] p-[24px]">
            ...
            <h2 className="mt-5 text-[20px] md:text-24px font-bold text-pink-500">
              1. Hari Pertama: Pembagian Baksos (7 Semtember 2024)
            </h2>
            ...
            <p className="mt-5 text-[18px] md:text-22px">
              Rangkaian kegiatan dimulai pada tanggal 7 Semtember 2024 dengan
            ...
            <h2 className="mt-5 text-[20px] md:text-24px font-bold text-pink-500">
              Pra-Acara HUT Smandela (13 Semtember 2024)
            </h2>

            <p className="mt-5 text-[18px] md:text-22px">
              Pada tanggal 13 Semtember 2024, pra-acara HUT Smandela berlangsung
            ...
            <h2 className="mt-5 text-[20px] md:text-24px font-bold text-pink-500">
              Puncak Acara HUT Smandela (25 Semtember 2024)
            </h2>

            <p className="mt-5 text-[18px] md:text-22px">
              Puncak perayaan HUT Smandela pada tanggal 25 Semtember 2024
            ...
            <h3 className="mt-5 text-[20px] md:text-24px font-bold text-purple-500">
            ...
            <img
              className="mt-5 pb-2 rounded-[25px] w-full"
              src={Rebana}
